// Migration test, step 1 (runs on the INSTALLED 1.0.7, driven via tauri-driver / BRISVIA_E2E_APP).
...
describe('Migration prepare — create a wallet on the installed 1.0.7', () => {
