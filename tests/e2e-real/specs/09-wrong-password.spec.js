// P0 flow #9 — Wrong password when revealing the phrase.
// On the real COMPILED app, verifies that if a WRONG password is entered when requesting the phrase
// (Settings -> Security -> Reveal), the backend REJECTS it: it shows an error message and does NOT reveal
...
describe('Flow 9 — wrong password', () => {
