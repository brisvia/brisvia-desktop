...
//! or a pool (stratum), while the RandomX engine stays the same. Per the integration plan
//! and the review guidance: "adapt around, don't refactor inside" — the audited solo hashing loop is
