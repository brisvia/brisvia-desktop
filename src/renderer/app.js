...
// -- Password step: encrypts the wallet (Core) and the 12-word phrase. Used for create and import. --
let passMode = 'create';
let importedWords = [];
...
// Strength 0..4: length + variety. A visual guide, not a strict block (the real backup is the 12 words).
