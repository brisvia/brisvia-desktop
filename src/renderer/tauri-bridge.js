  ...
  if (invoke) {
    ...
    window.brisvia = {
      ...
      wallet: {
        ...
        spendableSources: () => call('wallet_spendable_sources'),
        send: (address, amount, password, fromAddresses) => callE('wallet_send', { address, amount, password, fromAddresses: fromAddresses || null }),
        estimateSend: (address, amount, fromAddresses) => callE('wallet_estimate_send', { address, amount, fromAddresses: fromAddresses || null }),
